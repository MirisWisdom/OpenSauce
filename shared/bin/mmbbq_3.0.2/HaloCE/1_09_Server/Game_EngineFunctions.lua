...
HaloCEServer_Game_EngineFunctions_Index =
{
	...
	[33] = "K_WEAPON_PREVENTS_MELEE_ATTACK",
	[34] = "K_WEAPON_PREVENTS_GRENADE_THROWING",
	[35] = "K_WEAPON_STOP_RELOAD",
	[36] = "K_FIRST_PERSON_WEAPON_MESSAGE_FROM_UNIT",
	[37] = "K_WEAPON_GET_FIRST_PERSON_ANIMATION_TIME",
	[38] = "K_PERIODIC_FUNCTION_EVALUATE",
	[39] = "K_TRANSITION_FUNCTION_EVALUATE",
	[40] = "K_DATA_NEW",
	[41] = "K_DATUM_NEW_AT_INDEX",
	[42] = "K_DATUM_NEW",
	[43] = "K_DATUM_DELETE",
	[44] = "K_DATA_DELETE_ALL",
	[45] = "K_DATA_ITERATOR_NEXT",
	[46] = "K_DATA_NEXT_INDEX",
	[47] = "K_DATUM_TRY_AND_GET",
	[48] = "K_DATUM_INITIALIZE",
	[49] = "K_MODEL_FIND_MARKER",
	[50] = "K_HUD_CHAT_TO_NETWORK",
	[51] = "K_INDEX_RESOLUTION_TABLE_TRANSLATE",
	[52] = "K_MAIN_CONNECT",
	[53] = "K_HS_OBJECT_ORIENT",
	[54] = "K_OBJECT_HEADER_BLOCK_ALLOCATE",
	[55] = "K_OBJECT_ITERATOR_NEXT",
	[56] = "K_OBJECT_PLACEMENT_DATA_NEW",
	[57] = "K_OBJECT_NEW",
	[58] = "K_OBJECT_NEW_WITH_ROLE",
	[59] = "K_OBJECT_DELETE_TO_NETWORK",
	[60] = "K_OBJECT_DELETE",
	[61] = "K_OBJECT_ATTACH_TO_MARKER",
	[62] = "K_OBJECT_DETACH",
	[63] = "K_OBJECTS_FIND_IN_SPHERE",
	[64] = "K_OBJECT_START_INTERPOLATION",
	[65] = "K_OBJECT_RESET",
	[66] = "K_OBJECT_RECONNECT_TO_MAP",
	[67] = "K_OBJECT_DISCONNECT_FROM_MAP",
	[68] = "K_OBJECT_GET_ORIGIN",
	[69] = "K_OBJECT_GET_ORIENTATION",
	[70] = "K_OBJECT_GET_LOCATION",
	[71] = "K_OBJECT_SET_POSITION",
	[72] = "K_OBJECT_SET_POSITION_NETWORK",
	[73] = "K_OBJECT_RESTORE_BODY",
	[74] = "K_OBJECT_DEPLETE_BODY",
	[75] = "K_OBJECT_DEPLETE_SHIELD",
	[76] = "K_OBJECT_DOUBLE_CHARGE_SHIELD",
	[77] = "K_OBJECT_CAUSE_DAMAGE",
	[78] = "K_OBJECT_DEFINITION_PREDICT",
	[79] = "K_OBJECT_SET_SCALE",
	[80] = "K_OBJECTS_UPDATE",
	[81] = "K_OBJECT_UPDATE",
	[82] = "K_OBJECT_GET_MARKER_BY_NAME",
	[83] = "K_UNIT_UPDATE",
	[84] = "K_UNIT_SET_ANIMATION",
	[85] = "K_UNIT_ANIMATION_START_ACTION",
	[86] = "K_UNIT_GET_CUSTOM_ANIMATION_TIME",
	[87] = "K_UNIT_CAN_ENTER_SEAT",
	[88] = "K_UNIT_ENTER_SEAT",
	[89] = "K_UNIT_EXIT_VEHICLE",
	[90] = "K_UNIT_TRY_AND_EXIT_SEAT",
	[91] = "K_UNIT_OPEN",
	[92] = "K_UNIT_CLOSE",
	[93] = "K_UNIT_FIND_NEARBY_SEAT",
	[94] = "K_UNIT_EXIT_SEAT_END",
	[95] = "K_UNIT_CAN_SEE_POINT",
	[96] = "K_UNIT_DETACH_FROM_PARENT",
	[97] = "K_UNIT_START_USER_ANIMATION",
	[98] = "K_UNIT_DROP_CURRENT_WEAPON",
	[99] = "K_UNIT_DAMAGE_AFTERMATH",
	[100] = "K_UNIT_SCRIPTING_SET_CURRENT_VITALITY",
	[101] = "K_UNIT_ANIMATION_SET_STATE",
	[102] = "K_UNIT_INVENTORY_GET_WEAPON",
	[103] = "K_UNIT_THROW_GRENADE_RELEASE",
	[104] = "K_UNIT_CAUSE_PLAYER_MELEE_DAMAGE",
	[105] = "K_UNIT_SET_ACTIVELY_CONTROLLED",
	[106] = "K_UNIT_READY_DESIRED_WEAPON",
	[107] = "K_COLLISION_TEST_VECTOR",
	[108] = "K_PLAYER_INDEX_FROM_UNIT_INDEX",
	[109] = "K_PLAYER_TELEPORT",
	[110] = "K_PLAYER_EXAMINE_NEARBY_VEHICLE",
	[111] = "K_PLAYER_SET_ACTION_RESULT",
	[112] = "K_PLAYER_SET_ACTION_RESULT_TO_NETWORK",
	[113] = "K_SCENARIO_TRIGGER_VOLUME_TEST_POINT",
	[114] = "K_TAG_LOADED",
	[115] = "K_TAG_ITERATOR_NEXT",
	[116] = "K_UNICODE_STRING_LIST_GET_STRING",
}