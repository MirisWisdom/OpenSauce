...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		{
			TAG_ENUM(u_animation_source, Enums::input_output_channel);
		...
		struct _shader_model_definition
		{
			...
			TAG_ENUM(change_color_source, Enums::input_output_channel);
			PAD16;
			TAG_PAD(int32, 7);
			...
			struct {
				...
				TAG_FIELD(__flags_1, flags_1);
				PAD16;
				TAG_ENUM(color_source, Enums::input_output_channel);
				TAG_ENUM(animation_function, Enums::animation_function);
				TAG_FIELD(real, animation_period, "seconds");
		...
		struct s_shader_transparent_generic_stage
		{
			...
			TAG_ENUM(color0_source, Enums::input_output_channel);
		...
		{				
			...
			TAG_ENUM(meter_brightness_source, Enums::input_output_channel, "overall meter brightness (default is 1)");
			TAG_ENUM(flash_brightness_source, Enums::input_output_channel, "brightness of flash (default is 1)");
			TAG_ENUM(value_source, Enums::input_output_channel, "position of flash leading edge (default is 1)");
			TAG_ENUM(gradient_source, Enums::input_output_channel, "high color leading edge (default is 1)");
			TAG_ENUM(flash_extension_source, Enums::input_output_channel, "position of flash extension leading edge (default is 1)");
			PAD16;
			TAG_PAD(int32, 8);
		};
		...
		{	
			...
			TAG_ENUM(intensity_source, Enums::input_output_channel);
			PAD16;
			...
			TAG_ENUM(offset_source, Enums::input_output_channel);
			PAD16;
			...
			TAG_FIELD(real_fraction, parallel_brightness, "[0,1]");
			TAG_FIELD(real_rgb_color, parallel_tint_color);
			TAG_ENUM(tint_color_source, Enums::input_output_channel, "modulates perpendicular and parallel colors above");
			PAD16;
			TAG_PAD(int32, 8);
			PAD16;
			PAD16;
