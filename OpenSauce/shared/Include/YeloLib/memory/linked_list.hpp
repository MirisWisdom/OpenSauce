...
namespace Yelo
{
	...
	{
		ASSERT(list_head != nullptr, "attepting to delete a linked list with a NULL list head");
	...
	{
		ASSERT(list_head != nullptr, "attepting to remove from a linked list with a NULL list head");
