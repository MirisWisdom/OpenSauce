...
#include "Interface/OpenSauceUI/i_mouse_pointer.hpp"
...
namespace Yelo
{
	namespace Interface { namespace OpenSauceUI { namespace GwenUI
	{
		...
		class c_mouse_pointer_gwen final
			: public i_mouse_pointer
		{
			t_control_ptr m_mouse_control;
		...
		public:
			...
			void Initialize(ControlFactory::c_control_factory& control_factory, i_canvas& canvas) override;
