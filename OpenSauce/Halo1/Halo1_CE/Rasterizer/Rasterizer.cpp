...
#pragma region Settings
		c_settings_container::c_upgrades_container::c_upgrades_container()
			: Configuration::c_configuration_container("Upgrades"), m_maximum_rendered_triangles("MaximumRenderedTriangles", true)
...
#pragma warning(pop)
	...
	namespace Render
	{
		...
		static void PLATFORM_API RenderWindowHook(const uint16 local_player_index, void *render_camera, void *render_frustum, void *rasterizer_camera, void *rasterizer_frustum, void *rasterizer_target, const bool is_mirror)
		{
