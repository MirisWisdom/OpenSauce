...
namespace Yelo
{
	namespace Postprocessing { namespace Subsystem { namespace Internal {
		...
		void		c_internal_subsystem::DoPostProcesses(IDirect3DDevice9* pDevice, real frame_time, Enums::postprocess_render_stage render_point)
		{
			c_internal_subsystem::g_instance.DoPostProcessesImpl(pDevice, frame_time, render_point);
		}
		...
		void		c_internal_subsystem::DoPostProcessesImpl(IDirect3DDevice9* pDevice, real frame_time, Enums::postprocess_render_stage render_point)
		{	
