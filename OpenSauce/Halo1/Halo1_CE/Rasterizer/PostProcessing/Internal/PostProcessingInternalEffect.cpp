...
namespace Yelo
{
	namespace Postprocessing { namespace Subsystem { namespace Internal {		
		...
		{	
			...
			m_shader_variable->m_variable_datum->SetVariable(dx_effect, &m_variable_interp.GetCurrent());
		}
		void		c_internal_shader_variable_scripted_node::SetVariableSource(c_generic_shader_variable_node* shader_variable)
		{
			...
			m_shader_variable->m_variable_datum->CopyDefaultVariable(&m_variable_interp.GetStart());
			m_variable_interp.SetType((Enums::shader_variable_base_type)m_shader_variable->m_variable_datum->value_type.type, 
				m_shader_variable->m_variable_datum->value_type.count);
			m_variable_interp.Reset();
		}
		void		c_internal_shader_variable_scripted_node::UpdateVariable(Yelo::real delta_time)
		{
			m_variable_interp.Update(delta_time);
		}
		void		c_internal_shader_variable_scripted_node::SetInterpolationTime(float interp_time)
		{			
			m_variable_interp.Begin(interp_time);
		}
		/////////////////////////////////////////////////////////////////////
