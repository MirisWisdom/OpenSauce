        ...
        namespace PostProcessing
        {
            namespace Scripting
            {
                ...
                namespace Globals
                {
                    ...
                    {
                        return Generic::External::c_system_external::Instance().Enabled();
                    }

                    bool& Enabled_Internal()
                    {
                        return Generic::Internal::c_system_internal::Instance().Enabled();
                    }

                    bool& Enabled_MotionBlur()
                    {
                        return MotionBlur::c_system_motionblur::Instance().Enabled();
                    }

                    bool& Enabled_FXAA()
                    {
                        return FXAA::c_system_fxaa::Instance().Enabled();
                    }

                    real& MotionBlur_Amount()
                    {
                        return MotionBlur::c_system_motionblur::Instance().BlurAmount();
                    }
                }
