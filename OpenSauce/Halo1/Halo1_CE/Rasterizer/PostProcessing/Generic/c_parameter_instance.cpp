        ...
        namespace PostProcessing
        {
            namespace Generic
            {
                namespace EvaluateRuntimeValue
                {
                    ...
                    {
                        auto player_unit = Players::GetPlayerUnit(Players::LocalPlayerIndex());
                        ...
                        auto unit_color = &player_unit->object.change_colors2[2];

                        auto color = CAST_PTR(D3DXCOLOR*, data);
                        color->a = 1.0f;
                ...
                void c_parameter_instance::Ctor()
                {
                    m_members.parameter_type = Enums::_parameter_process_type_none;
                    m_members.m_flags.is_overriden = false;
                    m_members.parameter = nullptr;
                    m_members.interpolator = nullptr;
                    m_members.evaluate_runtime_value = nullptr;

                    m_members.m_values[0].pointer = nullptr;
                    m_members.m_values[1].pointer = nullptr;
                }

                void c_parameter_instance::Dtor()
                {
                    m_members.parameter_type = Enums::_parameter_process_type_none;
                    m_members.m_flags.is_overriden = false;
                    m_members.parameter = nullptr;
                ...
                void c_parameter_instance::CreateInterpolatorFunction()
                {
                    ...
                    switch (m_members.parameter->value_type.count)
                    {
                        ...
                        case 2: m_members.interpolator = new c_interp_function_pp_anim<2>(&m_members.parameter->animation_function);
                            break;
                        case 3: m_members.interpolator = new c_interp_function_pp_anim<3>(&m_members.parameter->animation_function);
                            break;
                        case 4: m_members.interpolator = new c_interp_function_pp_anim<4>(&m_members.parameter->animation_function);
                            break;
                    }
                ...
                void c_parameter_instance::CreateInterpolatorLinear()
                {
                    ...
                    switch (m_members.parameter->value_type.count)
                    {
                        ...
                        case 2: m_members.interpolator = new c_interp_linear<2>();
                            break;
                        case 3: m_members.interpolator = new c_interp_linear<3>();
                            break;
                        case 4: m_members.interpolator = new c_interp_linear<4>();
                            break;
                    }
