            ...
            namespace Generic
            {
                namespace Internal
                {
                    ...
                    void c_system_internal::GetInternalShaders()
                    {
                        ...
                        m_members_internal.m_shaders.count = static_cast<uint16>(m_members_internal.cache_shader_collection->shaders.Count);
                        ...
                        for (uint32 i = 0; i < m_members_internal.m_shaders.count; i++)
                        {
                            ...
                            auto shader_index = m_members_internal.cache_shader_collection->shaders[i].tag_index;
                    ...
                    void c_system_internal::GetInternalEffects()
                    {
                        ...
                        m_members_internal.m_effects.count = static_cast<uint16>(m_members_internal.cache_shader_collection->effects.Count);
                        ...
                        m_members_internal.m_effect_instances.count = static_cast<uint16>(m_members_internal.cache_shader_collection->effect_instances.Count);
                    ...
                    void c_system_internal::ClearInternalEffects()
                    {
                        ...
                        m_members_internal.m_effect_instances.effect_instance_list = nullptr;
                        m_members_internal.m_effect_instances.count = 0;

                        // delete the effect list
                        delete [] m_members_internal.m_effects.effect_list;
                        m_members_internal.m_effects.effect_list = nullptr;
                    ...
                    c_shader_postprocess* c_system_internal::GetShaderByIndex(datum_index index)
                    {
                        ...
                        for (auto i = 0; i < m_members_internal.m_shaders.count; i++)
                        {
                    ...
                    void c_system_internal::SetupRenderSets()
                    {
                        ...
                        for (auto i = 0; i < NUMBEROF(m_members_internal.m_render_sets); i++)
                        {
                            m_members_internal.m_render_sets[i].Ctor();
                            SetRenderSet(m_members_internal.m_render_sets[i], static_cast<Enums::postprocess_render_stage>(i));
                        }
                    }
                    ...
                    void c_system_internal::UpdateStatus()
                    {
                        ...
                        do
                        {
                            ...
                            if (!Fade::c_system_fade::Instance().IsReady())
                            {
                                break;
                            }
                    ...
                    {
                        if (index < 0 || index >= static_cast<int16>(m_members_internal.m_effect_instances.count))
                        {
                            return;
                        }
                    ...
                    void c_system_internal::SetEffectShaderInstanceActive(int16 index, int16 instance_index, bool active)
                    {
                        ...
                        if (instance_index < 0 || instance_index >= static_cast<int16>(m_members_internal.m_effects.effect_list[index].shader_instance_count))
                        {
                            return;
                        }
