...
static bool UnitDataFieldGetObjectIndex(const s_object_field_definition& field,
																							s_unit_data& unit, 
											  										  TypeHolder& result,
																							cstring data_name)
{
...
static void* UnitDataFieldGetIntegerImpl(const	s_object_field_definition& field,
																								s_unit_data& unit)
{
	using namespace Enums;
...
static bool UnitDataFieldGetInteger(const s_object_field_definition& field,
																					s_unit_data& unit,
																					TypeHolder& result,
																					void*)
{
...
static bool UnitDataFieldGetReal(const	s_object_field_definition& field,
																				s_unit_data& unit,
																				TypeHolder& result,
																				void*)
{
