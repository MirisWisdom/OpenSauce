...
static real* ObjectDataFieldGetRealImpl(const s_object_field_definition& field,
	...
	case _object_field_real_function_out:
		{
			...
			if(	function_index >= 0 &&
					function_index < k_number_of_outgoing_object_functions && 
...
static bool ObjectDataFieldGetReal(const	s_object_field_definition& field,
