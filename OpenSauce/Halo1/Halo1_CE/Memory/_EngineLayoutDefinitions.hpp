...
#define __EL_INCLUDE_RASTERIZER_SHADEREXTENSION	(__EL_INCLUDE_RASTERIZER + 2)
	#define __EL_RASTERIZER_SHADEREXTENSION_MODEL (__EL_INCLUDE_RASTERIZER_SHADEREXTENSION + 0)
