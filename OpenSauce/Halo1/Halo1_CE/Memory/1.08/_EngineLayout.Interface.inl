...
// Keystone.cpp
	...
	ENGINE_PTR(void**, KS_GETWINDOW,		0x6BD0C0, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KW_RELEASE,			0x6BD0D0, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KW_GETCONTROLBYID,	0x6BD0D4, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KC_SENDMESSAGE,		0x6BD0F0, FUNC_PTR_NULL);
