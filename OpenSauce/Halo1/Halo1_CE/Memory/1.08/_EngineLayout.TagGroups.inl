...
// CacheFiles.cpp
	...
	namespace Cache
	{
		...
		static cstring* K_CACHE_FILE_READ_HEADER_EXCEPTION_MAP_NAME = CAST_PTR(cstring*, PLATFORM_VALUE(0x6BDDC4, 0x62648C));
		...
		ENGINE_PTR(byte, MAP_LIST_ADD_SKIP_CRC_JZ,		0x4981CC, 0x48DBBE);

		FUNC_PTR(CALCULATE_MAP_CRC_CALL,				0x4981D5, 0x48DBC7);
	};
