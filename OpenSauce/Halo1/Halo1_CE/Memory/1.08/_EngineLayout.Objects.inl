...
// Units.cpp
	...
	//////////////////////////////////////////////////////////////////////////
	// Units.Animations
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x569096-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690A2-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_SWITCH_RETN,				0x5692B7-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(byte, unit_update_animation_primary_keyframe_jmp_tbl_count,		0x56909B-0x30, PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_update_animation_primary_keyframe_jmp_ptr,			0x5690AC-0x30, PTR_UNKNOWN);
	static const void* *UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693AC-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_UPDATE_ANIMATION_SEAT_ENTER_FINAL_KEYFRAME_HOOK,				0x569295-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_SEAT_ENTER_FINAL_KEYFRAME_RETN,				0x5692A4-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x5690EB-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690F7-0x30, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_SWITCH_RETN,					0x5692A4-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(byte, unit_update_animation_final_keyframe_jmp_tbl_count,		0x5690F0-0x30, PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_update_animation_final_keyframe_jmp_ptr,			0x569101-0x30, PTR_UNKNOWN);
	...
	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TABLE_ADJUST_SIZE,		0x5696E4-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_state_interruptable_indirect_tbl_ptr,		0x5696F1-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x5696E9-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569734-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_BUSY_INDIRECT_TABLE_ADJUST_SIZE,					0x569764-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_busy_indirect_tbl_ptr,					0x569771-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_BUSY_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56976B-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_BUSY_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569788-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TABLE_ADJUST_SIZE,				0x5697A4-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_state_loops_indirect_tbl_ptr,				0x5697AF-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x5697A7-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x5697C8-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_INDIRECT_TABLE_ADJUST_SIZE,				0x569815-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_weapon_ik_indirect_tbl_ptr,				0x569820-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_WEAPON_IK_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56981A-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_WEAPON_IK_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569838-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TABLE_ADJUST_SIZE,				0x569864-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_vehicle_ik_indirect_tbl_ptr,				0x569871-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x569869-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569888-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TABLE_ADJUST_SIZE,	0x569F3E-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_start_overlay_action_indirect_tbl_ptr,	0x569F49-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x569F43-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x56A02C-0x30, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_IS_BUSY_INDIRECT_TABLE_ADJUST_SIZE,							0x56D9ED-0x30, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_is_busy_indirect_tbl_ptr,							0x56D9FA-0x30, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_IS_BUSY_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56D9F4-0x30, PTR_UNKNOWN)
	);
	static const byte *UNIT_IS_BUSY_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x56DA10-0x30, FUNC_PTR_UNKNOWN)
	);
