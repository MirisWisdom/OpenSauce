...
// Units.cpp
	...
	static const void* *UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693C4-0x30, FUNC_PTR_UNKNOWN)
	);

	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_HOOK,		0x5696B0, 0x518040);
	FUNC_PTR(UNIT_ANIMATION_BUSY_HOOK,						0x569730, 0x5180C0);
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_HOOK,				0x569770, 0x518100);
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_HOOK,					0x5697D0, 0x518160);
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_HOOK,				0x569830, 0x5181C0);
