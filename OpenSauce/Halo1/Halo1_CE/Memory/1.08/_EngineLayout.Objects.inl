...
// Units.cpp
	...
	static const uintptr_t* *UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(
		const uintptr_t**, PLATFORM_VALUE(0x5693AC-0x30, 0x517D3C-0x30)
	);
	...
	static const uintptr_t* *UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(
		const uintptr_t**, PLATFORM_VALUE(0x5693C4-0x30, 0x517D54-0x30)
	);
	...
	static void** K_UNIT_ANIMATION_BUSY_CALL[] = {
