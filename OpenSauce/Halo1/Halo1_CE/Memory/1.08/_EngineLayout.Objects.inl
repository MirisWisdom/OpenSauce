...
// Units.cpp
	...
	//////////////////////////////////////////////////////////////////////////
	// Units.Animations
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x569096-0x30, 0x517A26-0x30);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690A2-0x30, 0x517A32-0x30);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_SWITCH_RETN,				0x5692B7-0x30, 0x517C47-0x30);
	ENGINE_PTR(byte, unit_update_animation_primary_keyframe_jmp_tbl_count,		0x56909B-0x30, 0x517A2B-0x30);
	ENGINE_PTR(void**, unit_update_animation_primary_keyframe_jmp_ptr,			0x5690AC-0x30, 0x517A3C-0x30);
	static const void* *UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693AC-0x30, 0x517D3C-0x30)
	);
	
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x5690EB-0x30, 0x517A7B-0x30);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690F7-0x30, 0x517A87-0x30);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_SWITCH_RETN,					0x5692A4-0x30, 0x517C34-0x30);
	ENGINE_PTR(byte, unit_update_animation_final_keyframe_jmp_tbl_count,		0x5690F0-0x30, 0x517A80-0x30);
	ENGINE_PTR(void**, unit_update_animation_final_keyframe_jmp_ptr,			0x569101-0x30, 0x517A91-0x30);
	static const void* *UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693C4-0x30, 0x517D54-0x30)
	);

	static void** K_UNIT_ANIMATION_STATE_INTERRUPTABLE_CALL[] = {
	...
	static void** K_UNIT_UNIT_ANIMATION_BUSY_CALL[] = {
	...
	FUNC_PTR(K_UNIT_ANIMATION_STATE_LOOPS_CALL,		0x5692AA-0x30, 0x517C3A-0x30);
	FUNC_PTR(K_UNIT_ANIMATION_WEAPON_IK_CALL,		0x567FEE-0x30, 0x51697E-0x30);
	FUNC_PTR(K_UNIT_ANIMATION_VEHICLE_IK_CALL,		0x567F86-0x30, 0x516916-0x30);
