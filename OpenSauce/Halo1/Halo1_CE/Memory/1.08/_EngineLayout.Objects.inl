...
// Units.cpp
	...
	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_HOOK,		0x5696B0, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_BUSY_HOOK,						0x569730, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_HOOK,				0x569770, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_HOOK,					0x5697D0, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_HOOK,				0x569830, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_START_OVERLAY_ACTION_HOOK,		0x569EE0, FUNC_PTR_UNKNOWN);
