...
// GameState.cpp
	...
	{
#if !PLATFORM_IS_DEDI
		CAST_PTR(void**, 0x482430), CAST_PTR(void**, 0x4CD007), CAST_PTR(void**, 0x4CD131),
		CAST_PTR(void**, 0x541E38), CAST_PTR(void**, 0x542749)
#else
		CAST_PTR(void**, 0x479F70), CAST_PTR(void**, 0x4B6517), CAST_PTR(void**, 0x4B6641),
		CAST_PTR(void**, 0x4FCDEC), CAST_PTR(void**, 0x4FD455)
#endif
	};
...
// Players.cpp
	...
	ENGINE_PTR(byte, K_PLAYER_EXAMINE_NEARBY_OBJECTS_SERVER_LAST_ENTRY_TYPE,0x47B232, 0x472CB2);
	...
	ENGINE_PTR(byte, K_PLAYER_EXAMINE_NEARBY_OBJECTS_CLIENT_LAST_ENTRY_TYPE,0x47B332, 0x472DB2);
	...
	ENGINE_PTR(byte, K_PLAYER_HANDLE_ACTION_LAST_ENTRY_TYPE,0x47C178, 0x473BF8);
