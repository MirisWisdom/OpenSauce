...
FUNC_PTR(SET_TEXTURE_SAMPLER_STAGE,				0x51C340, FUNC_PTR_NULL);
...
FUNC_PTR(GET_CMD_LINE_PARAMETER,			0x5460B0, 0x4FF8D0);
...
FUNC_PTR(DATA_MAKE_VALID,	0x4D3A90, 0x4BCA00);
...
FUNC_PTR(UNIT_CAN_ENTER_SEAT,			0x56A310, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_ENTER_SEAT,				0x56A440, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_EXIT_VEHICLE,				0x56F300, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_OPEN,                     0x56E820, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_CLOSE,					0x56E840, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_FIND_NEARBY_SEAT,			0x56A030, FUNC_PTR_UNKNOWN);
...
FUNC_PTR(PLAYER_SET_ACTION_RESULT,				0x47BB90, FUNC_PTR_NULL);
FUNC_PTR(PLAYER_SET_ACTION_RESULT_TO_NETWORK,	0x47BD80, FUNC_PTR_UNKNOWN);
