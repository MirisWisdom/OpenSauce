...
ENGINE_PTR(void*, MAP_LIST_ADD_SKIP_CRC_JZ,		0x4981FC, 0x48DBEE);
...
FUNC_PTR(UNIT_CAN_ENTER_SEAT,			0x56A340, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_ENTER_SEAT,				0x56A470, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_EXIT_VEHICLE,				0x56F330, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_OPEN,                     0x56E850, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_CLOSE,                    0x56E870, FUNC_PTR_UNKNOWN);
FUNC_PTR(UNIT_FIND_NEARBY_SEAT,			0x56A060, FUNC_PTR_UNKNOWN);
...
FUNC_PTR(PLAYER_SET_ACTION_RESULT,				0x47BBA0, FUNC_PTR_NULL);
FUNC_PTR(PLAYER_SET_ACTION_RESULT_TO_NETWORK,	0x47BD90, FUNC_PTR_UNKNOWN);
