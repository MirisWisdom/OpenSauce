...
// Rasterizer.cpp
	...
	namespace Render { namespace Lightmaps
	{
		...
		FUNC_PTR(SET_LIGHTMAP_HANDLER_CALL, 0x522F6C, FUNC_PTR_NULL);
	};};

#elif __EL_INCLUDE_FILE_ID == __EL_RASTERIZER_SKY
	namespace Render { namespace Sky
	{
		FUNC_PTR(FOG_ATMOSPHERIC_SKY_DATUM_HOOK, 0x54205F, FUNC_PTR_NULL);
		FUNC_PTR(FOG_ATMOSPHERIC_SKY_DATUM_RETN, 0x542066, FUNC_PTR_NULL);
		FUNC_PTR(FOG_PLANAR_SKY_DATUM_HOOK, 0x558DBC, FUNC_PTR_NULL);
		FUNC_PTR(FOG_PLANAR_SKY_DATUM_RETN, 0x558DC2, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_SKY_SKY_DATUM_HOOK, 0x51492E, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_SKY_SKY_DATUM_RETN, 0x514935, FUNC_PTR_NULL);
	};};
