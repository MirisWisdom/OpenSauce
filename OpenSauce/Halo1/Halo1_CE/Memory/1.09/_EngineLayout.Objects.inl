...
// Units.cpp
	...
	static uint32 K_MAXIMUM_UNIT_GRENADE_INDEX_REFS_32bit[] = {
		PLATFORM_VALUE(0x56D703, 0x51BE53)+1+0x30,
	};
	static uint32 K_MAXIMUM_UNIT_GRENADE_INDEX_REFS_8bit[] = {
		PLATFORM_VALUE(0x56D70F, 0x51BE5F)+3+0x30,	PLATFORM_VALUE(0x474BF4, 0x46C6F4)+2+0x10, 
	};
	...
	static const void* *UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693AC, 0x517D3C)
	);
	...
	static const void* *UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693C4, 0x517D54)
	);

	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_HOOK,		0x5696E0, 0x518070);
	FUNC_PTR(UNIT_ANIMATION_BUSY_HOOK,						0x569760, 0x5180F0);
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_HOOK,				0x5697A0, 0x518130);
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_HOOK,					0x569800, 0x518190);
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_HOOK,				0x569860, 0x5181F0);
