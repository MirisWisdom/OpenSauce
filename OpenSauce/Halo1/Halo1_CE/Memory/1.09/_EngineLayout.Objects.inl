...
// Units.cpp
	...
	//////////////////////////////////////////////////////////////////////////
	// Units.Animations
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x569096, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690A2, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_SWITCH_RETN,				0x5692B7, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(byte, unit_update_animation_primary_keyframe_jmp_tbl_count,		0x56909B, PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_update_animation_primary_keyframe_jmp_ptr,			0x5690AC, PTR_UNKNOWN);
	static const void* *UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693AC, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_UPDATE_ANIMATION_SEAT_ENTER_FINAL_KEYFRAME_HOOK,				0x569295, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_SEAT_ENTER_FINAL_KEYFRAME_RETN,				0x5692A4, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		0x5690EB, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_INDIRECT_TABLE_PTR,			0x5690F7, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_SWITCH_RETN,					0x5692A4, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(byte, unit_update_animation_final_keyframe_jmp_tbl_count,		0x5690F0, PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_update_animation_final_keyframe_jmp_ptr,			0x569101, PTR_UNKNOWN);
	static const void* *UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(
		const void**, PLATFORM_VALUE(0x5693C4, FUNC_PTR_UNKNOWN)
	);
	
	static uint32 K_UNIT_ANIMATION_STATE_INTERRUPTABLE_REFS[] = {
		PLATFORM_VALUE(0x569010, FUNC_PTR_UNKNOWN), 
		PLATFORM_VALUE(0x56936C, FUNC_PTR_UNKNOWN), 
		PLATFORM_VALUE(0x56AC38, FUNC_PTR_UNKNOWN)
	};
	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TABLE_ADJUST_SIZE,		0x5696E4, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_state_interruptable_indirect_tbl_ptr,		0x5696F1, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x5696E9, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_STATE_INTERRUPTABLE_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569734, FUNC_PTR_UNKNOWN)
	);
	
	// 0x40B5EA, 0x4343A8, 0x55D045, 0x5666FF, 0x56675B, 
	// 0x566D56, 0x56B788, 0x56EE6B, 0x56F7D5, 0x570239
	FUNC_PTR(UNIT_ANIMATION_BUSY_INDIRECT_TABLE_ADJUST_SIZE,					0x569764, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_busy_indirect_tbl_ptr,					0x569771, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_BUSY_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56976B, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_BUSY_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569788, FUNC_PTR_UNKNOWN)
	);
	
	// 0x5692AA
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TABLE_ADJUST_SIZE,				0x5697A4, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_state_loops_indirect_tbl_ptr,				0x5697AF, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x5697A7, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_STATE_LOOPS_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x5697C8, FUNC_PTR_UNKNOWN)
	);
	
	// 0x567FEE
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_INDIRECT_TABLE_ADJUST_SIZE,				0x569815, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_weapon_ik_indirect_tbl_ptr,				0x569820, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_WEAPON_IK_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56981A, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_WEAPON_IK_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569838, FUNC_PTR_UNKNOWN)
	);
	
	// 0x567F86
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TABLE_ADJUST_SIZE,				0x569864, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_vehicle_ik_indirect_tbl_ptr,				0x569871, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x569869, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_VEHICLE_IK_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x569888, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TABLE_ADJUST_SIZE,	0x569F3E, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_animation_start_overlay_action_indirect_tbl_ptr,	0x569F49, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x569F43, PTR_UNKNOWN)
	);
	static const byte *UNIT_ANIMATION_START_OVERLAY_ACTION_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x56A02C, FUNC_PTR_UNKNOWN)
	);
	
	FUNC_PTR(UNIT_IS_BUSY_INDIRECT_TABLE_ADJUST_SIZE,							0x56D9ED, FUNC_PTR_UNKNOWN);
	ENGINE_PTR(void**, unit_is_busy_indirect_tbl_ptr,							0x56D9FA, PTR_UNKNOWN);
	static byte* K_NUMBER_OF_UNIT_IS_BUSY_INDIRECT_TBL_ENTRIES = CAST_PTR(
		byte*, PLATFORM_VALUE(0x56D9F4, PTR_UNKNOWN)
	);
	static const byte *UNIT_IS_BUSY_INDIRECT_TABLE = CAST_PTR(
		const byte*, PLATFORM_VALUE(0x56DA10, FUNC_PTR_UNKNOWN)
	);
