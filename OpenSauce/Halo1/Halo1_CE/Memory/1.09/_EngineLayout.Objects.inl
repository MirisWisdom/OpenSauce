...
// Units.cpp
	...
	FUNC_PTR(UNIT_ANIMATION_STATE_INTERRUPTABLE_HOOK,		0x5696E0, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_BUSY_HOOK,						0x569760, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_STATE_LOOPS_HOOK,				0x5697A0, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_WEAPON_IK_HOOK,					0x569800, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_VEHICLE_IK_HOOK,				0x569860, FUNC_PTR_UNKNOWN);
	FUNC_PTR(UNIT_ANIMATION_START_OVERLAY_ACTION_HOOK,		0x569F10, FUNC_PTR_UNKNOWN);
