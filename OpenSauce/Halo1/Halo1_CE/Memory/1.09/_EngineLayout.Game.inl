...
// GameState.cpp
	...
	static void** K_GAME_SCENARIO_SWITCH_BSP_CALL[] =
	{
#if !PLATFORM_IS_DEDI
		CAST_PTR(void**, 0x482440), CAST_PTR(void**, 0x4CD037), CAST_PTR(void**, 0x4CD161),
		CAST_PTR(void**, 0x541E68), CAST_PTR(void**, 0x542779)
#else
		CAST_PTR(void**, 0x479F80), CAST_PTR(void**, 0x4B6547), CAST_PTR(void**, 0x4B6671),
		CAST_PTR(void**, 0x4FCE1C), CAST_PTR(void**, 0x4FD485)
#endif
	};
...
// Players.cpp
	...
	ENGINE_PTR(byte, K_PLAYER_EXAMINE_NEARBY_OBJECTS_SERVER_LAST_ENTRY_TYPE,0x47B242, 0x472CC2);
	...
	ENGINE_PTR(byte, K_PLAYER_EXAMINE_NEARBY_OBJECTS_CLIENT_LAST_ENTRY_TYPE,0x47B342, 0x472DC2);
	...
	ENGINE_PTR(byte, K_PLAYER_HANDLE_ACTION_LAST_ENTRY_TYPE,0x47C188, 0x473C08);
