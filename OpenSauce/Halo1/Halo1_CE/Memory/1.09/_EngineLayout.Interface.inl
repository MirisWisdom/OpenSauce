...
// GameUI.cpp
	...
	namespace Hud
	{
		...
		#pragma region Scale
		ENGINE_PTR(D3DXMATRIX, render_text_screenproj_matrix,			0x67CCE8, PTR_NULL);

		FUNC_PTR(RENDER_WIDGET_SET_SCREENPROJ_MATRIX_HOOK,				0x520845, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_WIDGET_SET_SCREENPROJ_MATRIX_HOOK_RETN,			0x52084C, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_TEXT_SET_SCREENPROJ_MATRIX_HOOK,				0x535043, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_TEXT_SET_SCREENPROJ_MATRIX_HOOK_RETN,			0x535048, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_MOTION_TRACKER_SET_SCREENPROJ_MATRIX_HOOK,		0x52F81B, FUNC_PTR_NULL);
		FUNC_PTR(RENDER_MOTION_TRACKER_SET_SCREENPROJ_MATRIX_HOOK_RETN,	0x52F826, FUNC_PTR_NULL);
