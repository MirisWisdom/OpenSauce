...
// Keystone.cpp
	...
	ENGINE_PTR(void**, KS_GETWINDOW,		0x6BD1A8, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KW_RELEASE,			0x6BD1B8, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KW_GETCONTROLBYID,	0x6BD1BC, FUNC_PTR_NULL);
	ENGINE_PTR(void**, KC_SENDMESSAGE,		0x6BD1D8, FUNC_PTR_NULL);
