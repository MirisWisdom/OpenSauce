...
// Units.cpp
	...
	//////////////////////////////////////////////////////////////////////////
	// Units.Infections
	FUNC_PTR(UNIT_CAUSE_PARENT_MELEE_DAMAGE_HOOK,		DUO_PTR(K_UNIT_CAUSE_PARENT_MELEE_DAMAGE_HOOK));
	FUNC_PTR(UNIT_CAUSE_PARENT_MELEE_DAMAGE_HOOK_RETN,	DUO_PTR(K_UNIT_CAUSE_PARENT_MELEE_DAMAGE_HOOK_RETN));

	//////////////////////////////////////////////////////////////////////////
	// Units.Animations
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		DUO_PTR(K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE_ADJUST_SIZE));
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_INDIRECT_TABLE_PTR,			DUO_PTR(K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_INDIRECT_TABLE_PTR));
	FUNC_PTR(UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_SWITCH_RETN,				DUO_PTR(K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_SWITCH_RETN));
	ENGINE_PTR(byte, unit_update_animation_primary_keyframe_jmp_tbl_count,		DUO_PTR(K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TBL_COUNT));
	ENGINE_PTR(void**, unit_update_animation_primary_keyframe_jmp_ptr,			DUO_PTR(K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_PTR));
	static const uintptr_t* UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE = CAST_PTR(uintptr_t*, K_UNIT_UPDATE_ANIMATION_PRIMARY_KEYFRAME_JMP_TABLE);
	
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE_ADJUST_SIZE,		DUO_PTR(K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE_ADJUST_SIZE));
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_INDIRECT_TABLE_PTR,			DUO_PTR(K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_INDIRECT_TABLE_PTR));
	FUNC_PTR(UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_SWITCH_RETN,					DUO_PTR(K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_SWITCH_RETN));
	ENGINE_PTR(byte, unit_update_animation_final_keyframe_jmp_tbl_count,		DUO_PTR(K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TBL_COUNT));
	ENGINE_PTR(void**, unit_update_animation_final_keyframe_jmp_ptr,			DUO_PTR(K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_PTR));
	static const uintptr_t* UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE = CAST_PTR(uintptr_t*, K_UNIT_UPDATE_ANIMATION_FINAL_KEYFRAME_JMP_TABLE);
