...
namespace Yelo
{
	namespace TagGroups { namespace TagFieldReplacements { namespace Scenario
	{
		...
		TAG_GROUP_BLOCK_FIELDS_DEFINE(scenario_bsp_lightmap_set) =
		{
			...
			TAG_FIELD_ENTRY(_field_tag_reference, "std. lightmap", &TAG_GROUP_REFERENCE_GET(bitmap) ),
			...
			TAG_FIELD_ENTRY(_field_tag_reference, "dir. lightmap 1", &TAG_GROUP_REFERENCE_GET(bitmap) ),
			TAG_FIELD_ENTRY(_field_tag_reference, "dir. lightmap 2", &TAG_GROUP_REFERENCE_GET(bitmap) ),
			TAG_FIELD_ENTRY(_field_tag_reference, "dir. lightmap 3", &TAG_GROUP_REFERENCE_GET(bitmap) ),
		...
		const uint32 k_sky_block_reference_index = 1;
		TAG_GROUP_BLOCK_FIELDS_DEFINE(scenario_bsp_sky_set_sky) =
		{
			...
			TAG_FIELD_ENTRY(_field_tag_reference, "sky", &TAG_GROUP_REFERENCE_GET(sky) ),
			TAG_FIELD_ENTRY_END()
		};
		...
		const uint32 k_bsp_block_reference_index = 1;
