...
API_FUNC_NAKED static void import_model_animations_proc_impl(s_file_reference& reference)
{
...
*/
static void PLATFORM_API import_model_animations_proc(wcstring* arguments)
{
	typedef bool (PLATFORM_API* _tool_build_paths)(wcstring directory, 
		void* arg_4, s_file_reference& out_reference, wchar_t out_path[256], void* arg_10);
	static const _tool_build_paths tool_build_paths = CAST_PTR(_tool_build_paths, 0x4119B0);

	typedef void (PLATFORM_API* _use_import_definitions)(const void* definitions, int32 count, 
	...
	if(tool_build_paths(*arguments, NULL, reference, out_path, NULL))
	{
