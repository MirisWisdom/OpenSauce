...
static void PLATFORM_API import_model_render_proc(wcstring* arguments)
{
...
static void PLATFORM_API import_model_proc(wcstring* arguments)
{
	...
	long_flags object_type_mask = 0;
	for(int32 x = 0; x < NUMBEROF(object_type_names); x++, object_type_mask = 1 << x)
	...
	typedef void (PLATFORM_API* _import_object_model)(cstring object_name, long_flags object_type_mask);
...
#include "Tool/LostToolCommands/Animations.inl"
#include "Tool/LostToolCommands/Sounds.inl"