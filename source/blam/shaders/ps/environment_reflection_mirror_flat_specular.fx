...
half4 PS_EnvironmentReflectionMirrorFlatSpecular(
    half4 Diff : COLOR0,
...
Technique EnvironmentReflectionMirrorFlatSpecular
{
    Pass P0
	{
#ifdef pc   
		...
		AlphaOp[0] = Disable;
#endif		
		PixelShader = compile TGT PS_EnvironmentReflectionMirrorFlatSpecular();
 	}
}
