...
namespace Yelo
{
	namespace Cache
	{
		enum
		{
			...
			k_tag_cache_base_address = k_game_state_base_address + Enums::k_game_state_allocation_size,
			...
			k_number_of_cache_read_buffers = 8,
			// NUMBER_OF_READ_BUFFERS
			k_number_of_cache_write_buffers = 1,
			// NUMBER_OF_WRITE_BUFFERS
			k_number_of_cache_overlapped_structures = 11,
