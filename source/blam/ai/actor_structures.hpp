...
namespace Yelo
{
	namespace AI
	{
		...
		struct s_actor_datum
		{
			...
			e_actor_default_state::type_t initial_state;
			e_actor_default_state::type_t return_state;
			PAD32; // unknown field
			PAD16;
			e_actor_default_state::type_t current_state;
		...
		struct s_swarm_datum : Memory::s_datum_base
		{
			...
			datum_index unit_indices[k_maximum_number_of_units_per_swarm];
