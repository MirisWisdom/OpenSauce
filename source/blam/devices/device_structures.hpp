...
namespace Yelo
{
	...
	namespace Objects
	{
		...
		}; ASSERT_SIZE(s_device_data, Enums::k_object_size_device - Enums::k_object_size_object);
		...
		}; ASSERT_SIZE(s_device_machine_data, Enums::k_object_size_machine - Enums::k_object_size_device);
		...
		struct s_device_control_data
		{
			...
			PAD16;
		}; ASSERT_SIZE(s_device_control_data, Enums::k_object_size_control - Enums::k_object_size_device);
		...
		}; ASSERT_SIZE(s_device_lightfixture_data, Enums::k_object_size_light_fixture - Enums::k_object_size_device);
		...
		}; ASSERT_SIZE(s_device_datum, Enums::k_object_size_device);
		...
		}; ASSERT_SIZE(s_device_machine_datum, Enums::k_object_size_machine);
		...
		}; ASSERT_SIZE(s_device_control_datum, Enums::k_object_size_control);
		...
		}; ASSERT_SIZE(s_device_lightfixture_datum, Enums::k_object_size_light_fixture);
	};
};