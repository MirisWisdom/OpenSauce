...
namespace Yelo
{
	namespace Tool
	{
		...
		{
			{ e_field_type::string,					"string",				"%s",									1,	"%s" },
			{ e_field_type::char_integer,			"char_integer",			"%d",									1,	"%d" },
			{ e_field_type::short_integer,			"short_integer",		"%i",									1,	"%i" },
			{ e_field_type::long_integer,			"long_integer",			"%i",									1,	"%i" },
			{ e_field_type::angle,					"angle",				"%e degrees",							1,	"%f" },
			{ e_field_type::tag,					"tag",					"%4s",									1,	"%04s" },
			{ e_field_type::word_enum,				"enum",					"%u",									1,	"%u" },
			{ e_field_type::long_flags,				"long_flags",			"%u",									1,	"%u" },
			{ e_field_type::word_flags,				"word_flags",			"%u",									1,	"%u" },
			{ e_field_type::byte_flags,				"byte_flags",			"%u",									1,	"%u" },
			{ e_field_type::point_2d,				"point_2d",				"x: %i\ty: %i",							2,	"%i %i" },
			{ e_field_type::rectangle_2d,			"rectangle_2d",			"t: %i\tb: %i\tl: %i\tr: %i",			4,	"%i %i %i %i" },
			{ e_field_type::rgb_color,				"rgb_color",			"r: %i\tg: %i\tb: %i",					3,	"%i %i %i" },
			{ e_field_type::argb_color,				"argb_color",			"a: %i\tr: %i\tg: %i\tb: %i",			4,	"%i %i %i %i" },
			{ e_field_type::real,					"real",					"%0.6f",								1,	"%f" },
			{ e_field_type::real_fraction,			"real_fraction",		"%0.6f",								1,	"%f" },
			{ e_field_type::real_point_2d,			"real_point_2d",		"x: %0.6f y: %0.6f",					2,	"%f %f" },
			{ e_field_type::real_point_3d,			"real_point_3d",		"x: %0.6f y: %0.6f z: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_vector_2d,			"real_vector_2d",		"i: %0.6f j: %0.6f",					2,	"%f %f" },
			{ e_field_type::real_vector_3d,			"real_vector_3d",		"i: %0.6f j: %0.6f k: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_quaternion,		"real_quaternion",		"i: %0.6f j: %0.6f k: %0.6f w: %0.6f",	4,	"%f %f %f %f" },
			{ e_field_type::real_euler_angles_2d,	"real_euler_angles_2d",	"x: %0.6f y: %0.6f",					2,	"%f %f" },
			{ e_field_type::real_euler_angles_3d,	"real_euler_angles_3d",	"x: %0.6f y: %0.6f z: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_plane_2d,			"real_plane_2d",		"i: %0.6f j: %0.6f d: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_plane_3d,			"real_plane_3d",		"i: %0.6f j: %0.6f k: %0.6f d: %0.6f",	4,	"%f %f %f %f" },
			{ e_field_type::real_rgb_color,			"real_rgb_color",		"r: %0.6f g: %0.6f b: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_argb_color,		"real_argb_color",		"a: %0.6f r: %0.6f g: %0.6f b: %0.6f",	4,	"%f %f %f %f" },
			{ e_field_type::real_hsv_color,			"real_hsv_color",		"h: %0.6f s: %0.6f v: %0.6f",			3,	"%f %f %f" },
			{ e_field_type::real_ahsv_color,		"real_ahsv_color",		"a: %0.6f h: %0.6f s: %0.6f v: %0.6f",	4,	"%f %f %f %f" },
			{ e_field_type::short_bounds,			"short_bounds",			"%i to %i",								2,	"%i %i"},
			{ e_field_type::angle_bounds,			"angle_bounds",			"%0.6f to %0.6f",						2,	"%f %f" },
			{ e_field_type::real_bounds,			"real_bounds",			"%0.6f to %0.6f",						2,	"%f %f" },
			{ e_field_type::real_fraction_bounds,	"real_fraction_bounds",	"%0.6f to %0.6f",						2,	"%f %f" },
			{ e_field_type::tag_reference,			"tag_reference",		"tag: %4s\tindex: %i",					0,	nullptr },
			{ e_field_type::block,					"block",				"count: %i\taddress: 0x%08X",			0,	nullptr },
			{ e_field_type::short_block_index,		"short_block_index",	"%i",									0,	nullptr },
			{ e_field_type::long_block_index,		"long_block_index",		"%i",									0,	nullptr },
			{ e_field_type::data,					"data",					"size: %i",								0,	nullptr },
			{ e_field_type::array_start,			"array_start",			nullptr,								0,	nullptr },
			{ e_field_type::array_end,				"array_end",			nullptr,								0,	nullptr },
			{ e_field_type::pad,					"pad",					nullptr,								0,	nullptr },
			{ e_field_type::skip,					"skip",					nullptr,								0,	nullptr },
			{ e_field_type::explanation,			"explanation",			nullptr,								0,	nullptr },
			{ e_field_type::custom,					"custom",				nullptr,								0,	nullptr },
			{ e_field_type::terminator,				"terminator",			nullptr,								0,	nullptr },
		};
