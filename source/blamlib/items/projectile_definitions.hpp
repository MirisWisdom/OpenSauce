...
namespace Yelo
{
	...
	namespace TagGroups
	{
		...
		}; ASSERT_SIZE(s_projectile_material_response_definition, 0xA0);
		...
		struct _projectile_definition
		{
			...
			}flags; ASSERT_SIZE(_projectile_definition_flags, sizeof(long_flags));
		...
		}; ASSERT_SIZE(_projectile_definition, 0xD0);
