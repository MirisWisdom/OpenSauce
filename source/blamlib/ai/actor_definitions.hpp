...
namespace Yelo
{
	namespace TagGroups
	{
		...
		namespace e_defensive_crouch_type
		{
			typedef enum : _enum
			{
				never,
		...
		namespace e_actor_movement_type
		{
			typedef enum : _enum
			{
				always_run,
		...
		namespace e_actor_special_fire_mode
		{
			typedef enum : _enum
			{
				none,
		...
		namespace e_actor_special_fire_situation
		{
			typedef enum : _enum
			{
				never,
		...
		struct s_actor_definition
		{
			...
			TAG_PAD(int32, 3);
			TAG_ENUM(type, AI::e_actor_type::type_t);
			PAD16;

			////////////////////////////////////////////////////////////////
			// perception
			TAG_FIELD(real, max_vision_distance, "world units", "maximum range of sight");
			TAG_FIELD(angle, central_vision_angle, "degrees",
			...
			PAD32;
			TAG_FIELD(angle, peripheral_vision_angle, "degrees",
				"maximum horizontal angle within which we can see targets out of the corner of our eye");
			TAG_FIELD(real, peripheral_distance, "world units",
			...
			TAG_FIELD(real, notice_projectile_chance, "[0,1]",
			...
			TAG_FIELD(real, dive_from_grenade_chance, "[0,1]",
			...
			TAG_FIELD(real, stationary_movement_dist, "world units",
			...
			TAG_FIELD(angle, begin_moving_angle, "degrees",
			...
			TAG_FIELD(int16, friends_retreating_trigger, "",
			...
			TAG_FIELD(real, surprise_distance, "world units",
			...
			TAG_FIELD(real, max_seek_cover_distance, "world units",
				"maximum distance we will consider going to find cover (zero = default)");
			TAG_FIELD(real, cover_damage_threshold, "[0,1]",
			...
			TAG_FIELD(real, berserk_damage_threshold, "[0,1]",
			...
			TAG_FIELD(real, old_position_avoid_dist, "world units",
			...
			////////////////////////////////////////////////////////////////
			// communication
			TAG_FIELD(real_bounds, noncombat_idle_speech_time, "seconds",
				"time between idle vocalizations when we are not in combat");
			TAG_FIELD(real_bounds, combat_idle_speech_time, "seconds",
		...
		struct s_actor_variant_definition
		{
			...
			TAG_FIELD(real_bounds, burst_return_length, "world units",
			...
			TAG_FIELD(real, new_target_burst_duration, "",
				"burst duration multiplier for newly appeared targets (zero = unchanged)");
			TAG_FIELD(real, new_target_burst_separation, "",
			...
			TAG_FIELD(real, moving_burst_separation, "",
			...
			TAG_FIELD(real, berserk_burst_separation, "",
			...
			TAG_ENUM(special_fire_mode, e_actor_special_fire_mode::type_t, "the type of special weapon fire that we can use");
			TAG_ENUM(special_fire_situation, e_actor_special_fire_situation::type_t,
			...
			TAG_FIELD(real, melee_abort_range, "world units",
				"if our target gets this far away from us, we stop trying to melee them");
			TAG_FIELD(real_bounds, berserk_firing_ranges, "world units",
				"if we are outside maximum range, we advance towards target, stopping when we reach minimum range");
			TAG_FIELD(real, berserk_melee_range, "world units",
				"while berserking, how close an enemy target must get before triggering a melee charge");
			TAG_FIELD(real, berserk_melee_abort_range, "world units",
				"while berserking, if our target gets this far away from us, we stop trying to melee them");
			TAG_PAD(int32, 2);

			////////////////////////////////////////////////////////////////
			// grenades
			TAG_ENUM(grenade_type, e_grenade_type::type_t, "type of grenades that we throw");
			TAG_ENUM(trajectory_type, e_trajectory_type::type_t, "how we throw our grenades");
			TAG_ENUM(grenade_stimulus, e_grenade_stimulus::type_t, "what causes us to consider throwing a grenade");
			TAG_FIELD(int16, minimum_enemy_count, "",
			...
			TAG_FIELD(real, collateral_damage_radius, "world units",
