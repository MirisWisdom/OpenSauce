...
#include <YeloLib/shaders/shader_postprocess_runtime.inl>

#include <YeloLib/shaders/shader_postprocess_globals_definitions.hpp>
#include <YeloLib/shaders/shader_postprocess_generic_definitions.hpp>
#include <YeloLib/shaders/effect_postprocess_generic_definitions.hpp>
#include <YeloLib/shaders/effect_postprocess_collection_definitions.hpp>