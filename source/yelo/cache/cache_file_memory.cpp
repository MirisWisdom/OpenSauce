...
*/
#include <yelo/yelo.h>
#include "yelo/cache/cache_file_memory.hpp"
#if PLATFORM_TYPE == PLATFORM_TOOL

#include <yelo/cache/cache_file_memory_gestalt_definitions.hpp>
#include <yelo/cache/cache_file_memory_layout_table_definitions.hpp>
