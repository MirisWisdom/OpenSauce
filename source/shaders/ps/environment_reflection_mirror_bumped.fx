...
half4 PS_EnvironmentReflectionMirrorBumped(
    half4 Diff : COLOR0,
    ...
    half4 Tex3  : TEXCOORD3) : COLOR
{
	...
	// combiner 0
	r4 = saturate(dot(((2 * r2) - 1), c_eye_forward));
	r5 = r3 * r3;
...
Technique EnvironmentReflectionMirrorBumped
{
    Pass P0
	{
#ifdef pc   
		...
		AlphaOp[0]	= Disable;
#endif		
		PixelShader = compile TGT PS_EnvironmentReflectionMirrorBumped();
 	}
}
