...
{
	partial class AutoUIBlamRealBounds
	{
		/// <summary> 
		...
		{
			this.ValueLower = new OpenSauceIDE.Aether.AutoUI.BlamControls.AutoUIBlamReal();
			this.ValueUpper = new OpenSauceIDE.Aether.AutoUI.BlamControls.AutoUIBlamReal();
		...
		private AutoUIBlamReal ValueLower;
		private AutoUIBlamReal ValueUpper;
