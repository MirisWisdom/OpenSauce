...
namespace BlamLib.Blam.Halo3.Tags
{
	...
	public class model_animation_tag_resource : TI.Definition
	{
		...
		public class resource : TI.Definition
		{
			...
			{
				Add(Unknown00 = new BlamLib.TagInterface.LongInteger());
				Add(Unknown04 = new BlamLib.TagInterface.LongInteger());
				Add(Unknown08 = new BlamLib.TagInterface.ShortInteger());
				Add(Unknown0A = new BlamLib.TagInterface.ShortInteger());
				Add(Unknown0C = new BlamLib.TagInterface.ByteInteger());
				Add(Unknown0D = new BlamLib.TagInterface.ByteInteger());
				Add(Unknown0E = new BlamLib.TagInterface.ShortInteger());
				Add(Unknown10 = new BlamLib.TagInterface.LongInteger());
				Add(Unknown14 = new BlamLib.TagInterface.LongInteger());
				Add(Unknown18 = new BlamLib.TagInterface.LongInteger());
	...
	public partial class render_geometry_api_resource_definition : TI.Definition
	{
		...
		public class s_tag_d3d_vertex_buffer : TI.Definition
		{
			...
			{
				Add(VertexCount = new BlamLib.TagInterface.LongInteger());
				Add(VertxType = new BlamLib.TagInterface.Enum());
				Add(VertexSize = new BlamLib.TagInterface.ShortInteger());
				Add(VertexBuffer = new BlamLib.TagInterface.Data(this));
			}
		};
		#endregion
		...
		public class s_tag_d3d_index_buffer : TI.Definition
		{
			...
			{
				Add(Unknown = new BlamLib.TagInterface.LongInteger());
