...
namespace BlamLib.Render.COLLADA.Core
{
	...
	public partial class ColladaInstanceController : ColladaElement
	{
		#region Fields
		...
		ColladaObjectElementList<ColladaSkeleton> _skeleton;
		ColladaObjectElementList<Fx.ColladaBindMaterial> _bindMaterial;
		...
		#region Children
		[XmlElement("skeleton")]
		public List<ColladaSkeleton> Skeleton
		{ get { return _skeleton.Value; } set { _skeleton.Value = value; } }

		[XmlElement("bind_material")]
		public List<Fx.ColladaBindMaterial> BindMaterial
